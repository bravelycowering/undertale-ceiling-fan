-- example battle with multiple opponents
return function(self)
	...
	-- starting dialogue
    self.dialogue:settext("* You encountered the Dummies.")
	-- define the three opponents, rather than storing them anywhere we can just add the acts right away
